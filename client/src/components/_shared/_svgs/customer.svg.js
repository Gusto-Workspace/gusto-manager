export function CustomerSvg(props) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={props.fillColor ?? "#131E36"}
        d="M109.7 73.1v877.8h329.2v-73.2h-256V146.3h658.3V512h73.1V73.1z"
      />
      <path
        fill={props.fillColor ?? "#131E36"}
        d="M256 256h512v73.1H256zm0 146.3h365.7v73.1H256zm0 146.3h219.4v73.1H256z"
      />
    </svg>
  );
}
