  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-2xl border border-darkBlue/10 bg-white p-4 shadow-sm">
        ...
        <div className="overflow-x-auto max-w-[calc(100vw-80px)] tablet:max-w-[calc(100vw-355px)] pb-2">
      ...
      <section className="rounded-2xl border border-darkBlue/10 bg-white p-4 shadow-sm">
        ...
        {/* Scroll X + Y */}
        <div className="overflow-x-auto overflow-y-auto max-h-[350px] max-w-[calc(100vw-80px)] tablet:max-w-[calc(100vw-355px)]">
          {loading ? (
