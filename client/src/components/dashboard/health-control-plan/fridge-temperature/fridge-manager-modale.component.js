...
export default function FridgeManagerModal({
  ...
  useEffect(() => {
    ...
    // NE PAS notifier le parent ici : la source est le parent, pas la modale
  }, [initialFridges]);
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000]" aria-modal="true" role="dialog">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-[980px] rounded-2xl border border-darkBlue/10 bg-white p-4 midTablet:p-5 shadow-2xl">
          {/* Header */}
      ...
      "
          ...
          {/* Formulaire add/edit */}
          <div className="mb-4 rounded-2xl border border-darkBlue/10 bg-white p-3">
