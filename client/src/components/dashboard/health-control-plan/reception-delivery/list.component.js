...
export default function ReceptionDeliveryList({
  ...
  return (
    <div className="rounded-2xl border border-darkBlue/10 bg-white p-4  midTablet:p-5 shadow">
      ...
      {/* Table */}
      <div className="overflow-x-auto max-w-[calc(100vw-83px)] midTablet:max-w-[calc(100vw-92px)] tablet:max-w-[calc(100vw-370px)] rounded-xl border border-darkBlue/10 p-2 pb-0">
        <table className="w-full text-[13px]">
          ...
          <tbody className="divide-y divide-darkBlue/10">
            ...
            {loading && (
              <tr>
                <td colSpan={7} className="text-center text-darkBlue/50">
