...
export default function GenericTemperatureList({
  ...
  return (
    <div className="rounded-2xl border border-darkBlue/10 bg-white p-4 midTablet:p-5 shadow">
      ...
      {/* Table */}
      <div className="overflow-x-auto max-w-[calc(100vw-83px)] midTablet:max-w-[calc(100vw-92px)] tablet:max-w-[calc(100vw-340px)] rounded-xl border border-darkBlue/10 p-2 pb-0">
