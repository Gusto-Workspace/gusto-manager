...
import ExceptionalOpeningsRestaurantComponent from "../../restaurant/exceptional-openings.restaurant.component";
    ...
    <div className={card}>
      <div className={cardInner}>
        ...
        {showExceptionalOpenings ? (
          <>
            <div className={divider} />
            <div id="reservation-parameters-exceptional-openings" tabIndex={-1}>
