...
export default function HeroSectionLandingComponent() {
  ...
  return (
    <section className="relative overflow-hidden min-h-[100dvh] flex flex-col justify-center px-4 pt-28 pb-14 tablet:px-6 tablet:pt-32 tablet:pb-20">
      ...
      <button
        ...
        className="relative z-10 mt-8 self-center tablet:mt-10"
