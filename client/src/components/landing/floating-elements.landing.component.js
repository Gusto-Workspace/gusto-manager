  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute left-[4%] bottom-[5%] opacity-0 animate-float-up-delay-3">
        <Martini className="text-white midTablet:text-orange w-12 midTablet:w-20 h-12 midTablet:h-20 " />
      </div>
      <div className="absolute left-[25%] top-[70%] opacity-0 animate-float-up-delay-4">
        <Coffee className="text-orange w-8 h-8 " />
      </div>
      <div className="hidden midTablet:block absolute left-[35%] bottom-[10%] opacity-0 animate-float-up-delay-5">
        <ChefHat className="text-orange w-8 h-8 " />
      </div>
      <div className="absolute right-[10%] midTablet:left-[25%] bottom-[10%] opacity-0 animate-float-diagonal-reverse-delay-1">
      ...
      {/* Éléments à droite */}
      <div className="absolute right-[6%] top-[15%] midTablet:top-[20%] opacity-0 animate-float-up-delay-3">
        <Soup className="text-orange w-10 h-10" />
      </div>
      <div className="hidden midTablet:block absolute right-[26%] top-[14%] opacity-0 animate-float-up-delay-1">
      ...
      <div className="hidden midTablet:block absolute right-[25%] bottom-[20%] opacity-0 animate-float-up-delay-4">
      ...
      {/* Éléments centraux */}
      <div className="hidden midTablet:block absolute left-[48%] bottom-[20%] opacity-0 animate-float-up-delay-1">
        <IceCreamCone className="text-white w-8 h-8" />
      </div>
      <div className="hidden midTablet:block absolute left-[46%] top-[10%] opacity-0 animate-float-diagonal-delay-2">
