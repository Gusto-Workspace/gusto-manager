    ...
    <section className="py-16 tablet:py-24 bg-darkBlue/5" id="avantages">
      <div className="container mx-auto px-4 tablet:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl tablet:text-4xl font-bold text-lightGrey mb-6">
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-3 gap-12 mb-16">
          <div className="bg-lightGrey border-lightGrey border bg-opacity-5 p-4 rounded-xl flex flex-col items-center text-center">
            <div className="bg-orange/10 p-6 rounded-full text-orange text-4xl my-2 animate-float">
              <Coffee />
            </div>
            <h3 className="text-xl font-bold text-lightGrey mb-3">
              Adapté aux besoins des restaurateurs
            </h3>
            <p className="text-lightGrey text-pretty">
          ...
          <div className="bg-lightGrey border-lightGrey border bg-opacity-5 p-4 rounded-xl flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-lightGrey mb-3">Évolutif</h3>
            <p className="text-lightGrey text-pretty">
