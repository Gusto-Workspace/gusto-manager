...
import SupplierCertificateForm from "@/components/dashboard/health-control-plan/suppliers-certificates/form.component";
import SupplierCertificateList from "@/components/dashboard/health-control-plan/suppliers-certificates/list.component";

// SVG
import { HealthSvg } from "@/components/_shared/_svgs/health.svg";

export default function SupplierCertificatePage(props) {
                ...
                <div className="flex justify-between  gap-4">
                  <div className="flex items-center gap-2 min-h-[40px]">
                    ...
                    <h1 className="pl-2 text-xl tablet:text-2xl flex items-center gap-2 flex-wrap">
                      ...
                      <>
                        <span>/</span>
                        <span>Certificats Fournisseurs</span>
                      </>
                    </h1>
                  </div>
                </div>
