...
import HealthMesuresForm from "@/components/dashboard/health-control-plan/health-mesures/form.component";
import HealthMesuresList from "@/components/dashboard/health-control-plan/health-mesures/list.component";
...
export default function HealthMesuresPage(props) {
                  ...
                  <HealthMesuresForm
                    ...
                    onSuccess={(doc) => {
                      ...
                      window.dispatchEvent(
                        new CustomEvent("health-mesures:upsert", {
                          detail: { doc },
                        }),
                      );
                    }}
