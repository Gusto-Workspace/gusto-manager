...
import MaintenanceForm from "@/components/dashboard/health-control-plan/maintenance/form.component";
import MaintenanceList from "@/components/dashboard/health-control-plan/maintenance/list.component";
                ...
                <div className="flex justify-between  gap-4">
                  <div className="flex items-center gap-2 min-h-[40px]">
                    ...
                    <h1 className="pl-2 text-xl tablet:text-2xl flex items-center gap-2 flex-wrap">
                      ...
                      <>
                        <span>/</span>
                        <span>Maintenance équipements</span>
                      </>
                    </h1>
                  </div>
                </div>
                  ...
                  <MaintenanceForm
                    ...
                    onSuccess={(doc) => {
                      ...
                      window.dispatchEvent(
                        new CustomEvent("maintenance:upsert", {
                          detail: { doc },
                        })
                      );
                    }}
