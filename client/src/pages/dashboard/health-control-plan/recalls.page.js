...
import RecallsForm from "@/components/dashboard/health-control-plan/recalls/form.component";
import RecallsList from "@/components/dashboard/health-control-plan/recalls/list.component";

// SVG
import { HealthSvg } from "@/components/_shared/_svgs/health.svg";

export default function RecallsPage(props) {
                ...
                <div className="flex justify-between  gap-4">
                  <div className="flex items-center gap-2 min-h-[40px]">
                    ...
                    <h1 className="pl-2 text-xl tablet:text-2xl flex items-center gap-2 flex-wrap">
                      ...
                      <>
                        <span>/</span>
                        <span>Retours marchandises NC</span>
                      </>
                    </h1>
                  </div>
                </div>
                  ...
                  <RecallsForm
                    ...
                    onSuccess={(doc) => {
                      ...
                      window.dispatchEvent(
                        new CustomEvent("recalls:upsert", {
                          detail: { doc },
                        })
                      );
                    }}
