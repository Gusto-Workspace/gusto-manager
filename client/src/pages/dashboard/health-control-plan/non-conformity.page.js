...
import NonConformityForm from "@/components/dashboard/health-control-plan/non-conformity/form.component";
import NonConformityList from "@/components/dashboard/health-control-plan/non-conformity/list.component";

// SVG
import { HealthSvg } from "@/components/_shared/_svgs/health.svg";

export default function NonConformityPage(props) {
                  ...
                  <NonConformityForm
                    ...
                    onSuccess={(doc) => {
                      ...
                      window.dispatchEvent(
                        new CustomEvent("non-conformity:upsert", {
                          detail: { doc },
                        })
                      );
                    }}
