...
import AddTakeAwayWebapp from "@/components/dashboard/webapp/take-away/add.take-away.webapp";

export default function TakeAwayWebappAddPage() {
  ...
  const employeeHasAccess =
    ...
    isEmployeeDashboardRouteAllowed("/dashboard/webapp/take-away/add", {
