...
import ParametersTakeAwayWebapp from "@/components/dashboard/webapp/take-away/parameters.take-away.webapp";

export default function TakeAwayWebappParametersPage() {
  ...
  const employeeHasAccess =
    ...
    isEmployeeDashboardRouteAllowed("/dashboard/webapp/take-away/parameters", {
