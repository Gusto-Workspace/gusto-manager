...
import MigrateSubscriptionAdminComponent from "@/components/dashboard/admin/subscriptions/migrate-subscription.admin.component";
    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="tablet:ml-[270px] bg-lightGrey text-darkBlue flex-1 px-2 p-6 mobile:p-6 mobile:px-6 flex flex-col gap-6 min-h-screen">
          <MigrateSubscriptionAdminComponent />
        </div>
      </div>
    </>
  );
