...
import ListCustomersComponent from "@/components/dashboard/customers/list.customers.component";
...
export default function CustomersPage(props) {
  ...
  const hasCustomersModule = !!restaurantOptions.customers;

  const user = restaurantContext.userConnected;
  const isEmployee = user?.role === "employee";

  let employeeHasCustomersAccess = true;
  ...
  if (isEmployee && restaurant) {
    ...
    employeeHasCustomersAccess = profile?.options?.customers === true;
  }
